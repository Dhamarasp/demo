                    ...
                    <tr>
                        <td colspan="3">
                            <span style="text-align: left; margin: 15px 10px; font-weight: bold; font-size: 13px;">
                                <p>Hai,</p>
                                <p>Kami melihat Kamu melakukan permintaan lupa password pada web https://cahayaagro.com.</p>
                                <br>
                                <p>Untuk melanjutkan, klik link di bawah ini untuk melakukan ubah password Kamu.</p>
                                <a href="{{url('/').'#forgot-password/'.$email.'/'.$key}}" style="background-color:#bd2e06; border-radius:6px; border:1px solid #d02718; display:inline-block; cursor:pointer; color:#ffffff; font-size:15px; padding:6px 24px; text-decoration:none;">
                                Aktivasi
                                </a>
                                <br>
                                <p>Kamu bisa mengabaikan pesan ini jika Kamu merasa tidak melakukan permintaan lupa password akun Kamu.</p>
                                <br>
                                <p>Terima kasih,</p>
                                <p>Cahaya Agro</p>
                                <br>
