                    ...
                    <tr>
                        <td colspan="3">
                            <span style="text-align: left; margin: 15px 10px; font-weight: bold; font-size: 13px;">
                                <p>Hai,</p>
                                <p>Terima kasih telah berbelanja di website https://cahayaagro.com.</p>
                                <br>
                                <p>Saat ini kami membutuhkan feedback dari Kamu untuk memajukan layanan kami.</p>
                                <a href="https://goo.gl/forms/WNihvQL0dWxp6EMs2" style="background-color:#bd2e06; border-radius:6px; border:1px solid #d02718; display:inline-block; cursor:pointer; color:#ffffff; font-size:15px; padding:6px 24px; text-decoration:none;">
                                Klik untuk isi form
                                </a>
                                <br>
                                <p>Terima kasih,</p>
